...
DEFAULT_COMMANDS: Tuple[CommandSpec, ...] = (
    ...
    _spec("permissions", description="Check the macOS permissions needed for safe window probing.", aliases=("permisos",), category="system", default_mode="instant"),
    _spec("windows", description="List currently visible macOS windows without moving them.", aliases=("ventanas",), category="system", default_mode="instant"),
    _spec("window", description="Run native macOS window actions on the frontmost window.", category="system", default_mode="instant"),
    _spec("layout", description="Inspect or preview the current Tuli window layout state.", category="system", default_mode="instant"),
    _spec("space", description="Control macOS Spaces with safe Mission Control keyboard shortcuts.", aliases=("desktop",), category="system", default_mode="instant"),
